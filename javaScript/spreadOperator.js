...
const arrayOfString1 = ["sakib", "mukit", "talha"];
const arrayOfString2 = ["rakib", "jahid", "arif"];
const arrayOfString3 = ["naziullah", "fahim", "abdullha"];

// to expend
const expend = [...arrayOfString1, arrayOfString2, arrayOfString3];
console.log(expend);

// to concat

const concat = [...arrayOfString1, ...arrayOfString2, ...arrayOfString3];
console.log(concat);

// to copy

const copy = [...arrayOfString1];
console.log(copy);
...
const expendObject = { ...object1, object2, object3 };
console.log(expendObject);

// to concat

const concatObject = { ...object1, ...object2, ...object3 };

console.log(concatObject);

// to copy

const copyObject = { ...object3 };
