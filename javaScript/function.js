...
fun(); //hello
//func();//reference error: func() is not defined
...
// create a function that takes an array and target value(number). output  will be the index of target if target present in an array.
