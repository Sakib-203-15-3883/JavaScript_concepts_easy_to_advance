...
const sum10 = sumOfNumbers(10, 10, 20, 10);
console.log(sum10);

// sometimes we use rest parameter during destructuring

const numbers11 = [1, 2, 3, 4, 5];
const numbers12 = [6, 7, 8, 9, 10];

const [value1, value2, ...restOfTheNumbers] = [...numbers11, ...numbers12];
